...
public class DefenseTower : MonoBehaviour
{
    ...
    [SerializeField] private float rateOfAccuracy; // 정확도
    ...
    [SerializeField] private Transform tf_TopGun; // 총을 발사할 위치  레이저계산의 타겟임 회전도 이걸로 (포탑)
    [SerializeField] private ParticleSystem particle_MuzlleFlash; // 총구섬광
